...
Training data was generated synthetically based on CVRPLIB benchmarks including P-n19-k2, P-n21-k2, P-n40-k5, and P-n51-k10. The configuration parameters are shown in Table~\ref{tab:config}.
...
Table~\ref{tab:comp} compares methods on 10-customer instances. Our DRL approach achieves competitive energy consumption (12.18 kWh) with significantly faster inference time (0.5s), making it suitable for real-time applications.
